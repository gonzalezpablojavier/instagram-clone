  ...
  return (
   ...
   <div></div>
      ...
      <main className="flex-grow mt-16 w-full max-w-5xl mx-auto">
        ...
        <div className="bg-yellow-500 text-white p-4 rounded shadow flex flex-col items-center justify-center">
            <h2 className="text-2xl font-semibold mb-4">¿Cómo me siento hoy?</h2>
          ...
          <div className="bg-cyan-600 text-white p-4 rounded shadow flex flex-col items-center justify-center">
            <h2 className="text-2xl font-semibold mb-4 font-montserrat"></h2>
            <div className="flex space-x-4">
              <h2 className="text-3xl font-semibold mb-4 font-montserrat"></h2>
            </div>
          </div>
          ...
          <h2 className="text-2xl font-semibold mb-4 font-montserrat">Estas en la ofi?</h2> 
